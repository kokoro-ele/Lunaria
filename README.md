...
1. 搜索城市并选择结果，或在 **3D 线框地球仪** 上点击选择观测地点
...
1. **选择地点**  
   在控制面板输入中英文城市名（至少两个字符），输入后自动搜索，再从悬浮列表中选择对应地区的结果，即可更新观测坐标和时区。也可以在地球仪上点击选点。搜索由 Open-Meteo / GeoNames 提供，需要网络连接；公共 API 适用于非商业用途，商业部署需按 [服务说明](https://open-meteo.com/en/pricing) 配置相应服务。
